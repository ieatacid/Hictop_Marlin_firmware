...
#define STRING_CONFIG_H_AUTHOR "(PJP, HICTOP i3 Mendel v1.1.0-RC8)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HICi3 v1.1RC8BF-AL-398"
 ...
 */
//PJP - Leaving this the default, but it is actually annoying in some cases
...
#define Z_PROBE_OFFSET_RANGE_MIN -1.5
#define Z_PROBE_OFFSET_RANGE_MAX 1.5
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //PJP - The more more warped your plate, the more points you need, up to 12?
  #define ABL_GRID_MAX_POINTS_X 8
  #define ABL_GRID_MAX_POINTS_Y 8

  // Set the boundaries for probing (where the probe can reach).
  //PJP - You will need to adjust these values to fit your probe location
  //These are my positions for the standard SN04-N sensor using an 
  //adjustable mount that can be found on Thingiverse
  //The closer you can get your sensor to the nozzle the better
...
//PJP - Boosted this up some, was very slow
...
// Preheat Constants
//Values from CL firmware
#define PREHEAT_1_TEMP_HOTEND 200 // CL: too low for current PLA, was=180
...
#define PREHEAT_2_FAN_SPEED 0 // Insert Value between 0 and 255
